...
class WidgetDataManager: NSObject {
    ...
    private let appGroupName = "group.com.siddg.locus.widgets"
    ...
    func updateNoteWidget(
        ...
        print("📱 [WidgetDataManager] fingerprint: \(fingerprint ?? "nil")")
        ...
        if let fingerprint = fingerprint as String? {
            widgetData["fingerprint"] = fingerprint
        }
